...
let add = calculateSum(num1, num2);
console.log(`sum of ${num1} and ${num2} result is ${add}`);
...
let products = calculateProduct(num1, num2);
console.log(`The calculated products ${num1} and ${num2} result is ${products}`)
